...
void humedad_0(uint8_t param)   //función para desactivar el modo
// *********************************************************************
{
  if (LCDML.FUNC_setup())         // ****** SETUP *********
  {
...
// *********************************************************************
{
  if (LCDML.FUNC_setup())         // ****** SETUP *********
  {
    ...
    for (int i = 0; i < NUMPIXELS; i++) {
      ...
      pixels2.setPixelColor(i, pixels.Color(r1, g1, b1));
      pixels2.show();
      delay(100);
    }
